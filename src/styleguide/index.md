...
<div class="row up-1 medium-up-3 large-up-5">
  <div class="column">
    <div class="color-block">
      <span style="background: #6772e5"></span>
      #6772e5
    </div>
  </div>
  <div class="column">
  ...
  <div class="column">
    <div class="color-block">
      <span style="background: #e39f48"></span>
      #e39f48
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #e25950"></span>
      #e25950
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #8f6ed5"></span>
      #8f6ed5
    </div>
  </div>
  <div class="column">
    <div class="color-block">
     <span style="background: #3297d3"></span>
     #3297d3
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #b76ac4"></span>
      #b76ac4
    </div>
  </div>
</div>
...
<p class="lead">This design uses Camphor for headings and paragraph text.</p>
...
<a href="#" class="button primary">Regular button</a>
<a href="#" class="button primary small">Small button</a>
<a href="#" class="button primary tiny">Tiny button</a>
```
...
These buttons are used to contrast against a dark background.

```html_example
<a href="#" class="button primary inverse">Inverse primary button</a>
<a href="#" class="button secondary inverse">Inverse secondary button</a>
```
